...
| ----------------- | --------------------------- | ---------------------------- |
| path              | path                        | 前端起始目录                 |
| token             | sha256(PASSWORD,ts,path,te) | 令牌，除密码外为可选参数     |
...
> `123456,download,/Abc,1735660800` 经 sha256 得到 `https://example.com/Abc/a.txt?token=28fcf3f3f207c9af4cfa16fdae789650a1953d81fb58b58fc1c30a762eb3f0ec&te=1735660800&format=pdf`
